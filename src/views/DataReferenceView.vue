          ...
          <el-scrollbar height="400px">
            <div v-if="currentLabReport" class="lab-report-info">
              <el-descriptions :column="2" size="small" border>
                <el-descriptions-item label="报告编号">{{ currentLabReport.reportNo || '-' }}</el-descriptions-item>
                <el-descriptions-item label="科室">{{ currentLabReport.department || '-' }}</el-descriptions-item>
                <el-descriptions-item label="报告医生">{{ currentLabReport.doctor || '-' }}</el-descriptions-item>
                <el-descriptions-item label="结论">{{ currentLabReport.conclusion || '-' }}</el-descriptions-item>
              </el-descriptions>
            </div>
            <div 
